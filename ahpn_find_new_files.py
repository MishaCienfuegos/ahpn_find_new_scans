...
def find_matches(existing_manifest_list, new_manifest_list):
  ...
  for row in existing_manifest_list:
    ...
    # TODO this shouldn't be necessary if the new manifest from calculate_new_manifest has the correct path now
    ...
    for row in new_manifest_list:
      ...
      # TODO clean up path_1 and path_2 names, should be 2/1/file_name.tif format, but path_2 is not
